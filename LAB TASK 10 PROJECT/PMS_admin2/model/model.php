...
function login_user($data) {
    ...
    */
    ...
    $conn = db_conn();
    $selectQuery = "SELECT * FROM staff WHERE name = :name AND password = :password";
...
function updateAdmin($data){
    $conn = db_conn();
    $selectQuery = "UPDATE staff set name = ?, gender = ?, dob = ? where id = 13";
    try{
        $stmt = $conn->prepare($selectQuery);
        $stmt->execute([
...
function updateAdminPass($data){
    $conn = db_conn();
    $selectQuery = "UPDATE staff set password = ? where id = 13";
    try{
        $stmt = $conn->prepare($selectQuery);
        $stmt->execute([
        	$data['password']
...
function updatePicture($data) {
    $conn = db_conn();
    $selectQuery = "UPDATE staff set image = ? where id = 13";
    try{
        $stmt = $conn->prepare($selectQuery);
        $stmt->execute([
        	$data['image']
...
function showStafffetch(){
	$conn = db_conn();
	$selectQuery = "SELECT * FROM `staff` where id = 13";
...
function getStaffId($data){
    $conn = db_conn();
	$selectQuery = "SELECT id FROM `staff` WHERE name = :name AND password = :password";
