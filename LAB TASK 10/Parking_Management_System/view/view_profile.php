					...
					<fieldset>
						...
						<table width="100%">
							...
							<td width="25%">Image: </td>
								<td width="25%" align="left"><img src="../uploads/<?php echo $_SESSION['image']?>" width="30%" height="30%"></td>
								<br>
								</tr>

								<tr>
							
								<!--<td><span>:</span><//?= $_SESSION['image']?></td>-->
								<td align="right" width="25%"><a href="change_pp.php">Change</a></td>
							</tr>
						</table><hr>
