				...
				<td width="75%">
					<fieldset>
						...
						<form method="post" action="../control/picture_upload.php" enctype="multipart/form-data">
							<table>
								<!--<tr><td><img src="<?php //$_SESSION['user']['profilePicPath'] ?>" height="200" width="200"></td></tr>-->
								<tr><td><img src="../uploaded_folder/<?php echo $_SESSION['image']; ?>" height="200" width="200"></td></tr>
